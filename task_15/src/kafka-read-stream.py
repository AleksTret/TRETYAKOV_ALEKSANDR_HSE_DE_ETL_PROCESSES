...
def main():
   ...
   query = spark.readStream.format("kafka")\
      .option("kafka.bootstrap.servers", "rc1b-3ehtpa1q1fv10t7n.mdb.yandexcloud.net:9091") \
   ...
   df.write.format("text").save("s3a://dataproc-bucket-aleks-tret/kafka-read-stream-output")
